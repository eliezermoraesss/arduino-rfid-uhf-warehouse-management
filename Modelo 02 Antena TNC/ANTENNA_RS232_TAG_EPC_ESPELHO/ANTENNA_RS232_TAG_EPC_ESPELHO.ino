...
#define COMMON_ANODE
#define STATUS 13
#define pinEstadoBluetoothHost 22
#define SS 53
...
void loop() {
  ...
  while (!estadoBluetoothPareadoHOST) {
    ...
    setColorRGB_2(255, 0, 0); // VERMELHO
    delay(200);
...
void setColorRGB_2(int vermelho_2, int verde_2, int azul_2) {

#ifdef COMMON_ANODE
  vermelho_2 = 255 - vermelho_2;
  verde_2 = 255 - verde_2;
  azul_2 = 255 - azul_2;
#endif

  analogWrite(ledRED_2, vermelho_2);
  analogWrite(ledGREEN_2, verde_2);
  analogWrite(ledBLUE_2, azul_2);
