/*
  REV. 07 ULTIMA ATUALIZACAO 05/04/2019
...
void backupDiariodoEstoque() {
  ...
  //******* 15:00 horas ******* Horário para o sistema efetuar o backup dos dados de estoque e salvar uma cópia diariamente no cartão microSD.
