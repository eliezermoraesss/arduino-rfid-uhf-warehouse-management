/*
   REV. 00 ULTIMA ATUALIZACAO 11/04/2019
   PROGRAMADOR E DESENVOLVEDOR: ELIEZER MORAES SILVA
*/

// *********************************************************************
// ************* CADASTRADOR DE TAGS RFID UHF PARA ANTENA RS232 ********
// *********************************************************************
...
#define delayLCDcadastro 1200
#define delayERROcadastro 1200
#define delayEscritaEPC 500
#define maxQuantidade 100
#define maxPosicao 110
#define ledRED 7
#define ledGREEN 6
#define ledBLUE 5
#define COMMON_ANODE
...
void setup() {
  ...
  nano.setReadPower(800); //5.00 dBm. Higher values may cause USB port to brown out
...
void sendStringToHost() {
  ...
  Serial.print("STRING ENVIADA PARA A HOST VIA BLUETOOTH: ");
  Serial.println(conteudoEPCSD);    //NOME DO ARQUIVO
