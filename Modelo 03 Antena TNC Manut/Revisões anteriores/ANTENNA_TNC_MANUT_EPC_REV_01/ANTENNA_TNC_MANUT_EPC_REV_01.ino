/*
  REV. 00 ULTIMA ATUALIZACAO 15/04/2019
...
String prefix = "EL";
String quantidadeAtualArquivo = "";
String valorProdutoBLE = "";
String valorProdutoCadastrador = "";
...
unsigned int quantidadeAtual = 0;
...
void setup() {
  ...
  /*for (int e = 1 ; e <= quantidadeProdutos ; e++) {
    ...
    myFile = SD.open(prefix + String(e) + ".txt");
    ...
    if (myFile) {
      ...
      while (myFile.available()) {
        ...
        EEPROM.write(e, conteudoSDcard.toInt());

        Serial.print(e);
        Serial.print(" - Atualizando EEPROM! - ");
        Serial.print(conteudoSDcard.toInt());
      ...
      Serial.println("ERRO AO ATUALIZAR EEPROM!");
  ...
  if (Serial1.available()) {
    ...
    if (num == 2) {
      ...
      if (myFile) {
        ...
        Serial.println("ERRO AO LER CONTEÚDO DO ARQUIVO EPC");

      }
      //*************************************************************************************************
      myFile = SD.open(prefix + conteudoSDcard + ".txt");

      if (myFile) {

        while (myFile.available()) {

          quantidadeAtualArquivo = myFile.readStringUntil('\n');
          quantidadeAtual = quantidadeAtualArquivo.toInt();
          quantidadeAtual++;  //INCREMENTA A QUANTIDADE DO PRODUTO ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

          Serial.print("QUANTIDADE LIDA NO ARQUIVO: ");
          Serial.println(quantidadeAtual);
        ...
        Serial.println("ERRO AO LER QUANTIDADE DO CARTÃO MICRO SD!");

      }
      //*************************************************************************************************

      SD.remove(prefix + conteudoSDcard + ".txt");

      //*************************************************************************************************
      myFile = SD.open(prefix + conteudoSDcard + ".txt", FILE_WRITE);

      if (myFile) {

        myFile.println(quantidadeAtual);
        Serial.println("QUANTIDADE GRAVADA NO CARTÃO MICRO SD!");

        myFile.close();

      } else {

        Serial.println("ERRO AO GRAVAR QUANTIDADE NO CARTÃO MICRO SD!");
...
void BLOCO_COMPARADOR_CONTADOR() {
  ...
  if (SD.exists(conteudoSCANNERfiltrado + ".txt")) {
    ...
    //*************************************************************************************************
    myFile = SD.open(prefix + conteudoSCANNERpartNumber + ".txt");
    ...
    if (myFile) {
      ...
      while (myFile.available()) {
        ...
        quantidadeAtualArquivo = myFile.readStringUntil('\n');
        quantidadeAtual = quantidadeAtualArquivo.toInt();
        quantidadeAtual--; //DECREMENTA A QUANTIDADE DO PRODUTO --------------------------------------------------------------------------------------------
    ...
    SD.remove(prefix + conteudoSCANNERpartNumber + ".txt");

    //*************************************************************************************************
    myFile = SD.open(prefix + conteudoSCANNERpartNumber + ".txt", FILE_WRITE);
...
void BLOCO_COMPARADOR_CONTADOR_ESPELHO() {
  ...
  if (SD.exists(conteudoESPELHO + ".txt")) {
    ...
    //*************************************************************************************************
    myFile = SD.open(prefix + conteudoESPELHOpartNumber + ".txt");
    ...
    SD.remove(prefix + conteudoESPELHOpartNumber + ".txt");

    //*************************************************************************************************
    myFile = SD.open(prefix + conteudoESPELHOpartNumber + ".txt", FILE_WRITE);
    ...
    conteudoSCANNERpartNumber = conteudoESPELHOpartNumber;
...
void datalogger() {
  ...
  dadosDatalogger = data + ',' + hora + ',' + conteudoSCANNERpartNumber.toInt() + ',' + sinal + ',' + String(quantidadeAtual);
...
void dataloggerADD() {
  ...
  dadosDatalogger = data + ',' + hora + ',' + conteudoSDcard + ',' + sinal + ',' + String(quantidadeAtual);
