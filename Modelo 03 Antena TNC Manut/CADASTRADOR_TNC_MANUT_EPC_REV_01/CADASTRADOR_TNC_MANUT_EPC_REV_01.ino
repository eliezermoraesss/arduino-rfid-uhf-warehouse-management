/*
   REV. 01 ULTIMA ATUALIZACAO 29/06/2019
...
void recebeDadosHost() {
  ...
  if (Serial1.available()) {
    ...
    if (pacoteDadosCadastrador.length() <= 7) {
      ...
      if (numeroProdutoCadastrador.length() <= 3 && quantidadeProdutoCadastrador.toInt() <= maxQuantidade) {
