/*
   REV. 1 ULTIMA ATUALIZACAO 10/01/2019
...
#define horaDisparoEmail 100000
...
void setup() {
  ...
  delay(1000); //Espera 10 segundos para ocorrer o pareamento completo com a HOST
