/*
  REV. 09 ULTIMA ATUALIZACAO 10/01/2019
...
#define delayRemota 100
#define horaDisparoEmail 92200
#define horaTerminoEmail 92300
...
void loop() {
  ...
  if ((tempoRTC >= horaDisparoEmail) && (tempoRTC < horaTerminoEmail)) {
    horaDisparo = true;
    Serial.println("FOI!");
  } else {
    horaDisparo = false;
  ...
  if (estadoBluetoothPareadoRemota && horaDisparo) {
    habilitaEmail = true;
  }
